	...
	<!-- *** HOMEPAGE CAROUSEL ***-->
        	 ...
        	 <div class="home-carousel col-md-6">
        	 	<ol class="breadcrumb">
        	 	 ...
        	 	 <div class="homepage owl-carousel">
                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/cooler-master.jpg" width="100%">
                                </div>
                        </div>

                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/cooler-master2.jpg" width="100%">
                                </div>
                        </div>

                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/cooler-master3.jpg" width="100%">
                                </div>
                        </div>

                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/cooler-master4.jpg" width="100%">
                                </div>
                        </div>

                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/cooler-master5.jpg" width="100%">
                                </div>
                        </div>
				...
				<div class="titulo-prod col-md-6">
			    	...
			    	<h3>COOLER PARA PROCESSADOR COOLER MASTER BLIZZARD T2, RR-T2-22FP-R1</h3>
			    ...
			    <div class="col-md-3">
			    	<a href="<?php echo BASE_URL ?>helpers/validate-cart.php" data-id="376" data-handler="new_product" class="button-cart btn btn-info btn-lg btn-block" style="border-radius: 5px; margin-top: 60px; padding: 15px;">Comprar</a>
			    </div>
        ...
        <section>
        	<div class="container">
                ...
                <tr class="tabela-cor">
                <td>Material Dissipador</td>
                <td>Alumínio</td>
                </tr>
                <tr>
                <td>Tamanho do Fan</td>
                <td >92x92x25</td>
                </tr>
                <tr class="tabela-cor">
                <td>Velocidade do Cooler</td>
                <td>2200 rpm +/- 10%</td>
                </tr>
                <tr>
                <td>Fluxo de Ar</td>
