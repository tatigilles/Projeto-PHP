    ...
    <!-- *** HOMEPAGE CAROUSEL ***-->
             ...
             <div class="home-carousel col-md-6">
                <ol class="breadcrumb">
        	 	 ...
        	 	 <div class="homepage owl-carousel">
                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/eletronicos/tablet-samsung-tab.jpg">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/tablet-samsung-tab2.jpg" width="100%">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/tablet-samsung-tab3.jpg" alt="">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/tablet-samsung-tab4.jpg" width="100%">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/tablet-samsung-tab5.jpg" alt="">
                                </div>
                        </div>
				...
				<div class="titulo-prod col-md-6">
			    	...
			    	<h3>Tablet Samsung Galaxy Tab E T560 8GB Wi-Fi Tela 9.6" Android 4.4 Quad-Core - Preto</h3>
			    ...
			    <div class="col-md-3 caixa-compra">
			    	...
			    	<h3>Por: R$ 779,00</h3>
			    	<h5>6x de R$ 129,83 s/ juros</h5>
			    </div>

			    <div class="col-md-3">
			    	<a href="<?php echo BASE_URL ?>helpers/validate-cart.php" data-id="383" data-handler="new_product" class="button-cart btn btn-info btn-lg btn-block" style="border-radius: 5px; margin-top: 60px; padding: 15px;">Comprar</a>
			    </div>
        ...
        <section>
        	<div class="container">
        		...
        		<div class="col-md-12">
                        <p>Uma visualização incrível em uma tela de 9.6 polegadas. Essa é apenas uma das diversas características que fazem do Galaxy Tab E um verdadeiro computador de bolso. Com ele, sua experiência digital será completa para jogar, ouvir músicas, ver filmes, usar as redes sociais e muito mais. Um companheiro perfeito para as horas de estudo, trabalho e lazer.</p>

                        <p>Com uma espessura de 8.5 mm e pesando somente 490 gramas, o Galaxy Tab E é equipado com Wi-fi, Processador Quad Core de 1.3GHz e 8GB de espaço interno, com suporte a cartões micro SD de até 128GB.</p>
