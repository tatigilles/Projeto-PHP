	...
	<!-- *** HOMEPAGE CAROUSEL ***-->
        	 ...
        	 <div class="home-carousel col-md-6">
        	 	<ol class="breadcrumb">
        	 	 ...
        	 	 <div class="homepage owl-carousel">
                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/placa-video.jpg" width="100%">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/hardware/placa-video2.jpg" width="100%">
                                </div>
                        </div>
				...
				<div class="titulo-prod col-md-6">
			    	...
			    	<h3>Placa de Video GTX970 4GB G1 Gaming DDR5 PCI-E Gigabyte GV-N970G1 GAMING-4GD"</h3>
			    ...
			    <div class="col-md-3 caixa-compra">
			    	...
			    	<h5>10x de R$ 264,99 s/ juros</h5>
			    </div>

			    <div class="col-md-3">
			    	<a href="<?php echo BASE_URL ?>helpers/validate-cart.php" data-id="368" data-handler="new_product" class="button-cart btn btn-info btn-lg btn-block" style="border-radius: 5px; margin-top: 60px; padding: 15px;">Comprar</a>
			    </div>
        ...
        <section>
        	<div class="container">
        		...
        		<div class="col-md-12">
        			<p>Seja para aprimorar fotos, editar vídeos, assistir filmes, jogar ou se simplesmente deseja uma experiência completa, a Placa de Vídeo Gigabyte traz um incrível poder de processamento gráfico para seu PC.
                    Rápida e eficiente, proporciona um desempenho de mudança de jogo para impressionantes belos gráficos e interação com o ambiente realista.</p>
					<br><hr>
        		</div>
                ...
                <tr>
                <td>Tipo de acessório para PC</td>
                ...
                <tr>
                <td>Modelo</td>
                <td >GTX970 - 4GB - G1 GAMING - DDR5 - PCI-E</td>
                </tr>
                </table>
