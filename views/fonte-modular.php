        	 ...
        	 <div class="home-carousel col-md-6">
        	 	<ol class="breadcrumb">
        	 	 ...
        	 	 <div class="homepage owl-carousel">
                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/font-modular.jpg" width="100%">
                                </div>
                        </div>

                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/font-modular2.jpg" width="100%">
                                </div>
                        </div>
				...
				<div class="titulo-prod col-md-6">
			    	...
			    	<h3>FONTE CORSAIR RM550 550W MODULAR, CERTIFICADO 80PLUS GOLD, PFC ATIVO, CP-9020053-WW - BOX</h3>
