	...
	<!-- *** HOMEPAGE CAROUSEL ***-->
        	 ...
        	 <div class="home-carousel col-md-6">
        	 	<ol class="breadcrumb">
        	 	 ...
        	 	 <div class="homepage owl-carousel">
                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/computadores/computador6.jpg" width="100%">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/computadores/computador6.1.jpg" width="100%">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/computadores/computador6.2.jpg" width="100%">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/computadores/computador6.3.jpg" width="100%">
                                </div>
                        </div>
                    </div>
					</div>
				...
				<div class="titulo-prod col-md-6">
			    	...
			    	<h3>All in One Dell 7ª Geração Intel Core i3 4GB 1TB LED 23.8 Full HD Linux Branco</h3>
			    ...
			    <div class="col-md-3 caixa-compra">
			    	...
			    	<h3>Por: R$ 3.063,00</h3>
			    	<h5>10x de R$ 305,90 s/ juros</h5>
			    </div>

			    <div class="col-md-3">
			    	<a href="<?php echo BASE_URL ?>helpers/validate-cart.php" data-id="343" data-handler="new_product" class="button-cart btn btn-info btn-lg btn-block" style="border-radius: 5px; margin-top: 60px; padding: 15px;">Comprar</a>
			    </div>
        ...
        <section>
        	<div class="container">
        		...
        		<div class="col-md-12">
        			<p>Sofisticado, compacto, fácil de instalar e usar.</p>
                    <p>Economize espaço e energia, instale o seu sistema em qualquer lugar com apenas um cabo e ainda aproveite a praticidade do teclado e mouse sem fio.</p>

                    <p>Tudo que você e sua família precisam em um único pacote atraente: computador, tela, mouse, teclado, alto-falantes e webcam. As impressionantes e finas telas LED Full HD IPS permitem uma visualização ampla para trabalho e diversão e a 7a geração de processadores Intel garante uma experiência incrível e performance rápida. Conexão wireless que permite bater papo com amigos e familiares ou reproduzir músicas e filmes de forma rápida e segura, enquanto que as outras portas oferecem recursos de interação perfeita com outros dispositivos.</p>
