	...
	<!-- *** HOMEPAGE CAROUSEL ***-->
        	 ...
        	 <div class="home-carousel col-md-6">
        	 	<ol class="breadcrumb">
        	 	 ...
        	 	 <div class="homepage owl-carousel">
                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/hardware/placa-mae-am4.jpg" width="100%">
                                </div>
                        </div>
				...
				<div class="titulo-prod col-md-6">
			    	...
			    	<h3>Placa mãe AM4 - AsRock AB350M-HDV (Micro ATX)</h3>
			    ...
			    <div class="col-md-3 caixa-compra">
			    	...
			    	<h3>Por: R$ 409,00</h3>
			    	<h5>6x de R$ 68,16 s/ juros</h5>
			    </div>

			    <div class="col-md-3">
			    	<a href="<?php echo BASE_URL ?>helpers/validate-cart.php" data-id="369" data-handler="new_product" class="button-cart btn btn-info btn-lg btn-block" style="border-radius: 5px; margin-top: 60px; padding: 15px;">Comprar</a>
			    </div>
        ...
        <section>
        	<div class="container">
        		...
        		<div class="col-md-12">
        			<p>Placa mãe padrão Micro ATX compatível com processador AMD Ryzen / AMD Athlon Séria A,chipset AMD B350,conexões VGA + DVI-D + HDMI,Dual Channel DDR4 3.200MHz (O.C.) até 32GB,PCI Express 16x,PCI Express 1x,SATA III 6Gb/s / M.2 / RAID,áudio de 8 (7.1) canais,rede Gigabit (Realtek),USB v3.0,USB v2.0,PS/2.</p>
					<br><hr>
        		</div>
