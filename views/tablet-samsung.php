    ...
    <!-- *** HOMEPAGE CAROUSEL ***-->
             ...
             <div class="home-carousel col-md-6">
                <ol class="breadcrumb">
        	 	 ...
        	 	 <div class="homepage owl-carousel">
                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/eletronicos/tablet-samsung.jpg">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/tablet-samsung2.jpg" width="100%">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/tablet-samsung3.jpg" alt="">
                                </div>
                        </div>
				...
				<div class="titulo-prod col-md-6">
			    	...
			    	<h3>Tablet Samsung Galaxy Tab S3 32GB 4G Tela 9.7" Quad-Core 2.15 GHz - Prata</h3>
			    ...
			    <div class="col-md-3 caixa-compra">
			    	...
			    	<h3>Por: R$ 2.499,99</h3>
			    	<h5>6x de R$ 416,66 s/ juros</h5>
			    </div>

			    <div class="col-md-3">
			    	<a href="<?php echo BASE_URL ?>helpers/validate-cart.php" data-id="381" data-handler="new_product" class="button-cart btn btn-info btn-lg btn-block" style="border-radius: 5px; margin-top: 60px; padding: 15px;">Comprar</a>
			    </div>
        ...
        <section>
        	<div class="container">
        		...
        		<div class="col-md-12">
                        <p>Aproveite toda a finura de um smartphone com todos os benefícios de um Tablet pela primeira vez. O Samsung Galaxy Tab S3 oferece um design Premium, com uma parte traseira em vidro, que apresenta um toque altamente sofisticado para o manuseio.</p>
