    ...
    <!-- *** HOMEPAGE CAROUSEL ***-->
             ...
             <div class="home-carousel col-md-6">
                <ol class="breadcrumb">
        	 	 ...
        	 	 <div class="homepage owl-carousel">
                        <div class="item">
                                <div class="col-md-12">
                                    <img class="img-responsive img-banner" src="img/eletronicos/ipad.jpg">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/ipad2.jpg" width="100%">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/ipad3.jpg" alt="">
                                </div>
                        </div>
                        ...
                        <div class="item">
                                ...
                                <div class="col-md-12">
                                    <img class="img-responsive" src="img/eletronicos/ipad4.jpg" width="100%">
                                </div>
                        </div>
				...
				<div class="titulo-prod col-md-6">
			    	...
			    	<h3>Ipad 32GB Wi-Fi Tela 9,7" Câmera 8MP Prata - Apple</h3>
			    ...
			    <div class="col-md-3 caixa-compra">
			    	...
			    	<h3>Por: R$ 2.999,99</h3>
			    	<h5>6x de R$ 499,99 s/ juros</h5>
			    </div>

			    <div class="col-md-3">
			    	<a href="<?php echo BASE_URL ?>helpers/validate-cart.php" data-id="380" data-handler="new_product" class="button-cart btn btn-info btn-lg btn-block" style="border-radius: 5px; margin-top: 60px; padding: 15px;">Comprar</a>
			    </div>
        ...
        <section>
        	<div class="container">
        		...
        		<div class="col-md-12">
                        <p>Tecnologia de ponta com o iPad da Apple,perfeito para jogar, navegar e criar. Com tela de 9,7¿ e vários apps para fazer o que quiser. Fácil de usar simples e intuitivo para navegar na internet, ler ou responder e-mail, tirar fotos, comprar online, jogar entre outros. E mais: Até 10 horas de bateria para você ficar conectado sem preocupação. Um excelente iPad para uso pessoal ou profissional, completo para fazer suas atividades com a praticidade que merece. Aproveite!</p>
				...
				<tr>
				<td>Modelo</td>
				<td>IPAD WI-FI CELLULAR 128GB SILVER-BRA</td>
				</tr>
				<tr class="tabela-cor">
				<td>Cor</td>
				<td>Prata</td>
				...
				<tr>
				<td>Processador</td>
				<td >Chip A9 com arquitetura de 64 bits, Coprocessador M9 integrado</td>
				</tr>
				<tr class="tabela-cor">
				<td>Tamanho do Display</td>
				<td>9,7 polegadas (diagonal)</td>
				</tr>
				<tr>
				<td>Resolução</td>
				<td>Resolução de 2048 x 1536 pixels</td>
				</tr>
				<tr class="tabela-cor">
				<td>Conexão</td>
				<td>Wi-Fi</td>
